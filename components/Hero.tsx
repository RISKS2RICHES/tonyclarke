...
const Hero: React.FC = () => {
  ...
  return (
    <div className="bg-white pt-6 pb-8 md:pt-16 md:pb-16">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col md:flex-row items-center gap-6 md:gap-12">
          
          {/* Text Content */}
          <div className="md:w-3/5 text-center md:text-left order-2 md:order-1">
            <div className="inline-block mb-3 px-3 py-1 border-2 border-navy-900">
              <span className="text-navy-900 text-[10px] sm:text-xs font-black tracking-widest uppercase">
                Intelligence & Security Strategy
              </span>
            </div>
            
            <h1 className="text-4xl sm:text-5xl md:text-6xl font-extrabold text-navy-900 mb-3 tracking-tighter leading-tight uppercase">
