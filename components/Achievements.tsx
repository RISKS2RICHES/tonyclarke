...
const Achievements: React.FC = () => {
  return (
    <section id="impact" className="pt-8 pb-12 md:py-12 bg-white">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="mb-6 md:mb-10 border-b-2 border-navy-100 pb-3">
          <h2 className="text-navy-900 text-2xl sm:text-3xl font-black uppercase tracking-tight">Key Impact</h2>
        </div>
